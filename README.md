...
The preferred submission artifact is EAS presentation build `78f574bd-a52b-48ce-8992-d9f66fdf9e01`, version 1.0.3 / Android build 5. It adds the dedicated animated progress experience to OCR analysis and has now been installed and reported working on the physical iQOO. Build 4 (`3fc84609-d3b0-4fbe-b4e4-71e24c053f7b`, version 1.0.2 / Android build 4) remains the fully exercised fallback: it launched without Metro and completed camera, OCR, voice, approval, real pytest verification, and rollback on the same phone.
