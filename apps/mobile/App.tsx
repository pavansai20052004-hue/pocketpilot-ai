...
const styles = StyleSheet.create({
  ...
  header: { minHeight: 80, paddingHorizontal: 18, paddingVertical: 9, borderBottomColor: '#202720', borderBottomWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 }, headerStatus: { flexShrink: 0, alignItems: 'flex-end', gap: 5 }, brand: { flexDirection: 'row', alignItems: 'center', gap: 9, flexShrink: 1 }, markImage: { width: 38, height: 38, borderRadius: 11 }, brandName: { color: '#F4F7F1', fontSize: 12, letterSpacing: 1.35, fontWeight: '900' }, brandSub: { color: '#60695D', fontSize: 8, letterSpacing: 1.1, marginTop: 2 },
