...
| Demo reliability | Resettable broken repositories, genuine tests, readiness checks, bounded retries, safe start/stop helpers | M6, M8–M9 | Release matrix passed Python 5/5, Java 2/2 with Maven/JUnit, and React 2/2, including rollback and restored failures |
