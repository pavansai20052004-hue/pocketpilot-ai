...
| Standalone APK | PASS | Current EAS presentation build `650b5267-6f98-417f-8b26-7b8a57ce5e61` finished successfully for version 1.0.1 / Android build 3. The downloaded signed APK is 138,170,532 bytes with SHA-256 `E88EAB79B9ECD74B2E5BFA9C95D7B19D2B2126BE377F943281181CCD713BCBEC`. The preceding build 2 installed and completed the physical iQOO workflow with Metro stopped; build 3 adds the safe top inset and truthful animated long-task states and still requires the final physical layout glance. |
